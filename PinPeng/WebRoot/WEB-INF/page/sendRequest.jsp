...
<link rel="stylesheet" type="text/css" href="css/bootstrap.css" media="all">
	...
	<form class="form-horizontal" action="sendrequest" method="post">
		...
		<div class="control-group">
    		...
    		<div class="controls">
				<input type="text" name="price" id="inputprice" placeholder="已消费金额" />元
    		</div>
    	</div>
    	...
    	<div class="control-group">
    		...
    		<div class="controls">
				<input type="text" name="moneyAmountNeed" id="inputmoneyamountneed" placeholder="优惠需要金额" />元    		
			</div>
    	</div>
    	...
    	<div class="control-group">
    		<label class="control-label" for="inputmaxpeople">希望拼单人数不超过</label>
    		<div class="controls">
				<input type="number" name="maxpeople" id="inputmaxpeople" max=5 min=2 value=5 step=1 />人
			</div>
    	</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="radio ">
					<input type="radio" name="payer" id="inputpayer1" value="0" checked/>都可以
				</label>
				<label class="radio ">
					<input type="radio" name="payer" id="inputpayer2" value="1" />其他人
				</label>
				<label class="radio ">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="radio ">
					<input type="radio" name="othertakelimited" id="inputothertakelimited1" value="0" checked/>都可以
				</label>
				<label class="radio ">
					<input type="radio" name="othertakelimited" id="inputothertakelimited2" value="1" />其他人
				</label>
				<label class="radio ">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="radio ">
					<input type="radio" name="inputgoodsfree" id="inputgoodsfree1" value="0" checked/>都可以
				</label>
				<label class="radio ">
					<input type="radio" name="inputgoodsfree" id="inputgoodsfree2" value="1" />其他人
				</label>
				<label class="radio ">
