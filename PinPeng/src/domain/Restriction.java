...
public class Restriction  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Restriction(Integer maxPeople, Date endDay, Integer payer, Integer dormLimited, Integer othertakeLimited, Integer manLimited, Integer buyLimited, Integer goodsFree) {
    ...
    /** full constructor */
    public Restriction(Myrequest myrequest, Myorder myorder, Integer maxPeople, Date endDay, Integer payer, Integer dormLimited, Integer othertakeLimited, Integer manLimited, Integer buyLimited, Integer goodsFree, String notice) {
